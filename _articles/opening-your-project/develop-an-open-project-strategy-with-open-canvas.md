...
1.  [Using the template](http://acabunoc.github.io/open-canvas/), fill out Open Canvas for your project/idea. Read the description of what goes in each field (aloud, if you’re working in a group).
